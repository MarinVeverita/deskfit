    ...
    function returnOptions(day) {
        let options = {
            ...
            onStart: function(evt) {
                startDay = evt.from ? evt.from.id : day;
            },
            onAdd: function(evt) {
                handleOnAdd(evt, day);
            },
            onRemove: function(evt) {
                ...
                const dayOfWeek = currentDay[0].toUpperCase() + currentDay.substring(1);
    ...
    function handleOnAdd(evt, day, flag = false) {
        ...
        if (item.querySelector('.remove-workout') === null) {
            ...
            removeButton.onclick = () => {
                ...
                const csrfToken = getCSRFToken();
                const dayOfWeek = item.getAttribute('data-day')[0].toUpperCase() + item.getAttribute('data-day').substring(1);
